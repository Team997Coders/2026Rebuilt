...
public class FieldConstants {
  ...
  public static class Regions {
    ...
    public static final Rectangle2d behindOpposingHub =
        new Rectangle2d(
            Hub.oppFarLeftCorner, new Translation2d(fieldLength, LinesHorizontal.rightBumpStart));
    ...
    public static final Rectangle2d leftTrench =
        new Rectangle2d(
            ...
            new Translation2d(
                LinesVertical.hubCenter + LeftTrench.barWidth / 2,
    ...
    public static final Rectangle2d rightTrench =
        new Rectangle2d(
            ...
            new Translation2d(
                LinesVertical.hubCenter + RightTrench.barWidth / 2,
