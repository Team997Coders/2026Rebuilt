...
package frc.robot.commands;
  ...
  import java.util.function.Supplier; // kept for usage in the class
  // removed unused imports: DoubleSupplier, SignalMeasurement, AprilTagFieldLayout, AprilTagFields, DARE
import edu.wpi.first.math.controller.ProfiledPIDController;
import edu.wpi.first.math.trajectory.TrapezoidProfile;
import edu.wpi.first.math.util.Units;
import edu.wpi.first.wpilibj.smartdashboard.SmartDashboard;
import edu.wpi.first.wpilibj2.command.Command;
// removed unused imports: Pose2d, DriverStation, Constants
import frc.robot.subsystems.Drivebase;
import frc.robot.subsystems.vision.ObjectCamera;

public class objectLock extends Command {
  ...
  /** Creates a new Drive. */
  public objectLock(Drivebase drivebase, Supplier<double[]> speedXY, ObjectCamera camera) {
    ...
    SmartDashboard.putNumberArray("object Lock PID Constants", new Double[]{9.0, 2.0, 0.0});
  ...
  public void execute() {
    ...
    var valuesFromSmartDashbord = SmartDashboard.getNumberArray("object Lock PID Constants", pidValues);
    ...
    double targetYaw = camera.getYaw();
