...
public class PasShooter extends Command{
    ...
    public PasShooter(Shooter shooter, HubLock hubLock, PAVController pav)
    {
        m_shooter = shooter;
        m_pav = pav;
        m_hubLock = hubLock;
    ...
    public void execute()
    {
        ...
        m_shooter.moveFlywheel(m_pav.getVelocity() * 2 / Constants.ShooterConstants.flywheelRadius);
