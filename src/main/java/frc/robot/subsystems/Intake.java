...
public class Intake extends SubsystemBase {
    ...
    private static SparkMax extendMotor;
    ...
    public Command extend(){
        error = Constants.IntakeConstants.goal - encoderPosition();
        SmartDashboard.putNumber("error", error);
        return this.runOnce(() -> runExtendMotor(pid.calculate(encoderPosition(), Constants.IntakeConstants.goal)));
    }
