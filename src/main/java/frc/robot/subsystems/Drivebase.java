...
public class Drivebase extends SubsystemBase {
  ...
  public Pose2d getShooterPose()
  {
    ...
    return new Pose2d(robotPose.getX() - Units.inchesToMeters(12) * robotPose.getRotation().getCos(),
                      robotPose.getY() - Units.inchesToMeters(12) * robotPose.getRotation().getSin(), 
